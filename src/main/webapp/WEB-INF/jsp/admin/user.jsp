	...
	<div class="row">
		...
		<div class="panel panel-primary">
		  ...
		  <div class="panel-body">
		      <form id="dataForm" name="dataForm" action="${jjsc }/admin/saveUser" method="post">
		    <div class="col-md-12 form-inline" style="margin-top:10px">
		    <input type="hidden" name = "id" value="${user.id }">
				<div class="form-group col-md-6">
					<label class="control-label" style="float:left;width:125px"><h4> 用户名：</h4></label>
				...
				<div class="form-group col-md-6">
					<label class="control-label" style="float:left;width:125px"><h4> 密&nbsp;&nbsp;&nbsp;&nbsp;码：</h4></label>
				...
				<div class="form-group col-md-6">
					<label class="control-label" style="float:left;width:125px"><h4> 电&nbsp;&nbsp;&nbsp;&nbsp;话：</h4></label>
				...
				<div class="form-group col-md-6">
					<label class="control-label" style="float:left;width:125px"><h4> 地&nbsp;&nbsp;&nbsp;&nbsp;址：</h4></label>
				...
				<div class="form-group col-md-6">
					<label class="control-label" style="float:left;width:125px"><h4> 余&nbsp;&nbsp;&nbsp;&nbsp;额：</h4></label>
